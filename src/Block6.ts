...
export class Block6 implements IBlock{
    ...
    private showHide(){
        ...
        this._block2.draw(this._game.canvas, this._bottomMiddle);
    ...
    canMoveDown(): boolean {
        ...
        let temp1 = new Position(this._bottomMiddle.column, this._bottomMiddle.row + 1);
        ...
        if (this._topLeft.row == -2){
            ...
            temp1 = new Position(this._bottomMiddle.column, this._bottomMiddle.row + 2);
    ...
    canMoveRight(): boolean {
        ...
        if (this._angleOfRotation === 0 && 
            temp.column < Game.COL_SIZE && this._game.matrix[temp.row][temp.column] === 0 && 
            temp1.column < Game.COL_SIZE && this._game.matrix[temp1.row][temp1.column] === 0){
            return true;
        }
        ...
        if (this._angleOfRotation === 90 && 
            temp.column < Game.COL_SIZE && this._game.matrix[temp.row][temp.column] === 0 && 
            temp1.column < Game.COL_SIZE && this._game.matrix[temp1.row][temp1.column] === 0 && 
            temp2.column < Game.COL_SIZE && this._game.matrix[temp2.row][temp2.column] === 0){
            return true;
        }
        ...
        if (this._angleOfRotation === 270 && 
            temp.column < Game.COL_SIZE && this._game.matrix[temp.row][temp.column] === 0 && 
            temp2.column < Game.COL_SIZE && this._game.matrix[temp2.row][temp2.column] === 0 && 
            temp3.column < Game.COL_SIZE && this._game.matrix[temp3.row][temp3.column] === 0){
            return true;
        }
        return false;
    }
    ...
    canRoteate(): boolean {
        ...
        else if (angle === 180 && this._topLeft.row >= 1 && (this._topLeft.column + 1 < col -1) &&
        ...
        else if (angle === 360 && this._topLeft.row >= 1 && (this._topRight.column + 1 < col - 1) && (this._topLeft.column - 1> 0) &&
            this._game.matrix[this._topLeft.row][this._topLeft.column - 1] === 0 && 
            this._game.matrix[this._topRight.row][this._topRight.column - 1] === 0 &&
            this._game.matrix[this._topRight.row][this._topRight.column + 1] === 0 &&
            this._game.matrix[this._topMiddle.row][this._topMiddle.column + 1] === 0){
    ...
    rotateCounterClockWise(): boolean {
        if (this.canRoteate()){
            ...
            if (this._angleOfRotation === 90){
                this._topLeft = new Position(this._topLeft.column, this._topLeft.row + 1);
                this._topRight = new Position(this._topLeft.column, this._topRight.row - 1);
                this._topMiddle = new Position(this._topLeft.column, this._topMiddle.row);
                this._bottomMiddle = new Position(this._bottomMiddle.column, this._bottomMiddle.row - 1);
            }
