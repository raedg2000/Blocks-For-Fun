...
export class Block5 implements IBlock{
    ...
    constructor(game : Game, colorIndex: number, color:string){
        ...
        this._topRight = new Position(Math.floor( 1 + Game.COL_SIZE/2), -2);
        this._bottomRight = new Position(Math.floor( 1 + Game.COL_SIZE/2), -1);
    }
    ...
    private showHide(){
        ...
        this._block3.draw(this._game.canvas, this._topRight);
    }
    ...
    canMoveDown(): boolean {
        ...
        let temp2 = new Position(this._topRight.column, this._topRight.row + 1);
        ...
        if (this._topLeft.row == -2){
            ...
            temp2 = new Position(this._topRight.column, this._topRight.row + 2);
        }
    ...
    canMoveLeft(): boolean {
        ...
        if (this._angleOfRotation === 180  && temp1.column  >= 0 && 
            this._game.matrix[temp2.row][temp2.column] === 0 && 
            this._game.matrix[temp1.row][temp1.column] === 0 ){
            return true;
        }
    ...
    canRoteate(): boolean {
        ...
        else if (angle === 180 && this._topLeft.row >= 0 &&
            this._game.matrix[this._topLeft.row][this._topLeft.column + 1] === 0 ){
                return true;
        }
        else if (angle === 270 && this._topLeft.row >= 0 &&
            this._game.matrix[this._topLeft.row -1][this._topLeft.column] === 0 ){
                return true;
        }
        else if (angle === 360 && this._topLeft.row >= 0 &&
            this._game.matrix[this._topLeft.row][this._topLeft.column - 1] === 0 ){
                return true;
        }
        return false;
