...
export class Block10 implements IBlock{
    ...
    private showHide(){
        ...
        this._block2.draw(this._game.canvas, this._bottomRight);
    ...
    canMoveDown(): boolean {
        let row = Game.ROW_SIZE
        let temp = new Position(this._topLeft.column, this._topLeft.row + 1);
        let temp1 = new Position(this._bottomRight.column, this._bottomRight.row + 1);
        let temp2 = new Position(this._topMiddle.column, this._topMiddle.row + 1);
        let temp3 = new Position(this._topRight.column, this._topRight.row + 1);

        if (this._topLeft.row == -2){
            temp = new Position(this._topLeft.column, this._topLeft.row + 2);
            temp1 = new Position(this._bottomRight.column, this._bottomRight.row + 2);
            temp2 = new Position(this._topMiddle.column, this._topMiddle.row + 2);
            temp3 = new Position(this._topRight.column, this._topRight.row + 2);
        }
        ...
        if (this._angleOfRotation === 90 && 
            temp.row < row && this._game.matrix[temp.row][temp.column] === 0  &&
            this._game.matrix[temp1.row][temp1.column] === 0 ){
            return true
        }

        if (this._angleOfRotation === 180 && 
            temp.row < row && this._game.matrix[temp.row][temp.column] === 0  &&
            this._game.matrix[temp2.row][temp2.column] === 0  &&
            this._game.matrix[temp2.row][temp2.column] === 0 ){
            return true
        ...
        if (this._angleOfRotation === 270 && 
            (temp3.row < row && this._game.matrix[temp3.row][temp3.column] === 0 ) &&
            (this._game.matrix[temp1.row][temp1.column] === 0 ) ){
            return true
        }
    ...
    canMoveRight(): boolean {
        ...
        let temp3 = new Position(this._bottomRight.column + 1, this._bottomRight.row);
        
        if (this._angleOfRotation === 0 && temp2.column < Game.COL_SIZE && 
            this._game.matrix[temp2.row][temp2.column] === 0 &&
            this._game.matrix[temp3.row][temp3.column] === 0){
            return true;
        }

        if (this._angleOfRotation === 90 && temp3.column < Game.COL_SIZE && 
            this._game.matrix[temp.row][temp.column] === 0 &&
            this._game.matrix[temp1.row][temp1.column] === 0 &&
            this._game.matrix[temp3.row][temp3.column] === 0){
            return true;
        ...
        if (this._angleOfRotation === 180 && temp.column < Game.COL_SIZE && 
            this._game.matrix[temp.row][temp.column] === 0 &&
            this._game.matrix[temp3.row][temp3.column] === 0){
            return true;
        }

        if (this._angleOfRotation === 270 && temp.column < Game.COL_SIZE && 
            this._game.matrix[temp.row][temp.column] === 0 &&
            this._game.matrix[temp1.row][temp1.column] === 0 &&
            this._game.matrix[temp2.row][temp2.column] === 0){
            return true;
    ...
    canMoveLeft(): boolean {
        ...
        if (this._angleOfRotation === 180 && temp2.column  >= 0 && 
            this._game.matrix[temp2.row][temp2.column] === 0 && 
            this._game.matrix[temp3.row][temp3.column] === 0) {
        ...
        if (this._angleOfRotation === 270 && temp2.column  >= 0 && 
            this._game.matrix[temp.row][temp.column] === 0 && 
            this._game.matrix[temp1.row][temp1.column] === 0 && 
            this._game.matrix[temp3.row][temp3.column] === 0) {
    ...
    canRoteate(): boolean {
        ...
        else if (angle === 180 && this._topLeft.column >= 1 && this._topLeft.column  + 2 < col &&
            this._game.matrix[this._topLeft.row][this._topLeft.column- 1] === 0 &&
            this._game.matrix[this._topMiddle.row][this._topMiddle.column - 1] === 0 &&
            this._game.matrix[this._topRight.row][this._topRight.column - 1] === 0 &&
            this._game.matrix[this._topLeft.row][this._topLeft.column +  1] === 0 &&
            this._game.matrix[this._topLeft.row][this._topRight.column + 2] === 0){

            return true;
        }
        else if (angle === 270 && this._topLeft.row + 1 < Game.ROW_SIZE && 
            this._game.matrix[this._topLeft.row + 1][this._topLeft.column] === 0 &&
            this._game.matrix[this._topMiddle.row + 1][this._topMiddle.column] === 0 &&
            this._game.matrix[this._topRight.row + 1][this._topRight.column] === 0 &&
            this._game.matrix[this._topLeft.row - 1][this._topLeft.column] === 0 &&
            this._game.matrix[this._topLeft.row - 2][this._topRight.column] === 0 ){
