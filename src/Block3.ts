...
export class Block3 implements IBlock{
    ...
    constructor(game : Game, colorIndex: number, color:string){
        ...
        this._topRight = new Position(Math.floor( 2 + Game.COL_SIZE/2), -1);
    }
    ...
    canRotate(): boolean {
        ...
        if (angle === 90){
            if (this._topLeft.row > 1 && 
                ...
                this._game.matrix[this._topMiddle.row -1][this._topRight.column] === 0 &&
                this._game.matrix[this._topMiddle.row -2][this._topRight.column] === 0 &&
        ...
        else if (angle === 180 && this._topLeft.row >1 &&
    ...
    rotateCounterClockWise(): boolean {
        if (this.canRotate()){
            ...
            if (this._angleOfRotation === 90){
                ...
                this._topRight = new Position(this._topLeft.column , this._topLeft.row - 2);
            }
            else if (this._angleOfRotation === 180){
                this._topRight = new Position(this._topLeft.column + 2 , this._topLeft.row);
