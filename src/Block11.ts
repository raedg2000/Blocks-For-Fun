...
export class Block11 implements IBlock{
    ...
    canMoveDown(): boolean {
        ...
        let temp = new Position(this._topRight.column, this._topRight.row + 1);
        ...
        let temp3 = new Position(this._bottomLeft.column, this._bottomLeft.row + 1);
        
        if (this._topLeft.row == -2){
            temp = new Position(this._topRight.column, this._topRight.row + 2);
            temp1 = new Position(this._topMiddle.column, this._topMiddle.row + 2);
            temp2 = new Position(this._topLeft.column, this._topLeft.row + 2);
            temp3 = new Position(this._bottomLeft.column, this._bottomLeft.row + 2);
        }
       
        if (this._angleOfRotation === 0 &&  temp3.row < row &&
    ...
    canMoveRight(): boolean {
        ...
        let temp3 = new Position(this._bottomLeft.column + 1, this._bottomLeft.row);
        ...
        if (this._angleOfRotation === 180 && temp3.column < Game.COL_SIZE && 
            this._game.matrix[temp2.row][temp2.column] === 0 && 
            this._game.matrix[temp3.row][temp3.column] === 0){
            return true;
        }
    ...
    canMoveLeft(): boolean {
        ...
        if (this._angleOfRotation === 0 && temp2.column  >= 0 && 
            this._game.matrix[temp2.row][temp2.column] === 0 && 
            this._game.matrix[temp3.row][temp3.column] === 0 ){
            return true;
        }
        ...
        if (this._angleOfRotation === 90 && temp.column  >= 0 && 
            this._game.matrix[temp.row][temp.column] === 0 && 
            this._game.matrix[temp1.row][temp2.column] === 0 && 
            this._game.matrix[temp2.row][temp2.column] === 0 ){
            return true;
        }

        if (this._angleOfRotation === 180 && temp.column  >= 0 && 
            this._game.matrix[temp.row][temp.column] === 0 && 
            this._game.matrix[temp3.row][temp3.column] === 0 ){
            return true;
        }

        if (this._angleOfRotation === 270 && temp3.column  >= 0 && 
            this._game.matrix[temp.row][temp.column] === 0 && 
            this._game.matrix[temp1.row][temp1.column] === 0 && 
            this._game.matrix[temp3.row][temp3.column] === 0 ){
            return true;
    ...
    canRoteate(): boolean {
        ...
        if (angle=== 90 && this._topLeft.row >= 1 && 
            ...
            this._game.matrix[this._topRight.row][this._topRight.column -2] === 0){
            return true;
        }
        return false;
    }
